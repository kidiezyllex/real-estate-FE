...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left !text-[#374151] border-b pr-6 pb-2 pt-0 !pl-0",
      className
    )}
    {...props}
  />
