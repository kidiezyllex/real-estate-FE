...
export const ServiceContractDeleteDialog = ({ isOpen, isDeleting, onClose, onConfirm }: ServiceContractDeleteDialogProps) => {
  return (
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="bg-mainBackgroundV1 p-4 my-4 rounded-sm border border-mainDangerV1/20">
          <p className="text-mainTextV1 text-sm">
            Khi xóa hợp đồng dịch vụ, tất cả dữ liệu liên quan đến hợp đồng này sẽ bị xóa vĩnh viễn khỏi hệ thống và không thể khôi phục.
          </p>
        </div>
