...
export const HomeContractDeleteDialog = ({ isOpen, isDeleting, onClose, onConfirm }: HomeContractDeleteDialogProps) => {
  return (
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center text-mainDangerV1">
            ...
            Xác nhận xóa hợp đồng thuê nhà
          </DialogTitle>
        ...
        <div className="bg-mainBackgroundV1 p-4 my-4 rounded-sm border border-mainDangerV1/20">
          <p className="text-mainTextV1 text-sm">
            Khi xóa hợp đồng thuê nhà, tất cả dữ liệu liên quan đến hợp đồng này sẽ bị xóa vĩnh viễn khỏi hệ thống và không thể khôi phục.
          </p>
        </div>
